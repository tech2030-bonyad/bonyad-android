...
import fudex.bonyad.databinding.CartListviewModelBindingImpl;
import fudex.bonyad.databinding.CartproductviewModelBindingImpl;
import fudex.bonyad.databinding.CatogaryviewModelBindingImpl;
...
import fudex.bonyad.databinding.ChargewalletviewModelBindingImpl;
...
import fudex.bonyad.databinding.DetailmerchantproductviewModelBindingImpl;
import fudex.bonyad.databinding.DetailorderuserviewModelBindingImpl;
import fudex.bonyad.databinding.DetailproductmerchantviewModelBindingImpl;
import fudex.bonyad.databinding.DetailproductviewModelBindingImpl;
...
import fudex.bonyad.databinding.HomeproductviewModelBindingImpl;
import fudex.bonyad.databinding.ImagesmerchantviewModelBindingImpl;
...
import fudex.bonyad.databinding.MerchantHomeorderviewModelBindingImpl;
import fudex.bonyad.databinding.MerchanthomefragmentViewModelBindingImpl;
import fudex.bonyad.databinding.MerchanthomeviewModelBindingImpl;
import fudex.bonyad.databinding.MerchantordersfragmentviewModelBindingImpl;
import fudex.bonyad.databinding.MerchantprofileViewModelBindingImpl;
import fudex.bonyad.databinding.MerchantregisterviewModelBindingImpl;
import fudex.bonyad.databinding.MostproductlistviewModelBindingImpl;
import fudex.bonyad.databinding.MostproductviewModelBindingImpl;
import fudex.bonyad.databinding.MyerviceviewModelBindingImpl;
import fudex.bonyad.databinding.MyproductlistviewModelBindingImpl;
import fudex.bonyad.databinding.MyproductviewModelBindingImpl;
import fudex.bonyad.databinding.NotsListViewModelBindingImpl;
import fudex.bonyad.databinding.NotviewModelBindingImpl;
...
import fudex.bonyad.databinding.ProductorderviewModelBindingImpl;
import fudex.bonyad.databinding.ProductrateviewModelBindingImpl;
import fudex.bonyad.databinding.ProductsListviewModelBindingImpl;
import fudex.bonyad.databinding.ProductsitemviewModelBindingImpl;
import fudex.bonyad.databinding.ProfileviewModelBindingImpl;
import fudex.bonyad.databinding.RatingViewBindingImpl;
import fudex.bonyad.databinding.RatingViewModelBindingImpl;
import fudex.bonyad.databinding.RatingsListViewModelBindingImpl;
import fudex.bonyad.databinding.RatingsproductsViewModelBindingImpl;
...
import fudex.bonyad.databinding.TransactionsviewModelBindingImpl;
...
import fudex.bonyad.databinding.UserorderitemviewModelBindingImpl;
import fudex.bonyad.databinding.UserordersfragmentviewModelBindingImpl;
import fudex.bonyad.databinding.UserorderslistfragmentviewModelBindingImpl;
...
import fudex.bonyad.databinding.WalletListViewModelBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYRATINGPRODUCT = 35;

  private static final int LAYOUT_ACTIVITYRESETPASSWORD = 36;

  private static final int LAYOUT_ACTIVITYSELECTTYPE = 37;

  private static final int LAYOUT_ACTIVITYSPECIALISTS = 38;

  private static final int LAYOUT_ACTIVITYSTATICPAGE = 39;

  private static final int LAYOUT_ACTIVITYSTATISTICS = 40;

  private static final int LAYOUT_ACTIVITYSUBSCRIPTIONS = 41;

  private static final int LAYOUT_ACTIVITYTECHNICALHOME = 42;

  private static final int LAYOUT_ACTIVITYTECHNICALDETAILSAPOINTMENT = 43;

  private static final int LAYOUT_ACTIVITYTECHNICALREGISTER = 44;

  private static final int LAYOUT_ACTIVITYTECHNICALSERVICEDETAILS = 45;

  private static final int LAYOUT_ACTIVITYUSERHOME = 46;

  private static final int LAYOUT_ACTIVITYUSERREGISTER = 47;

  private static final int LAYOUT_ACTIVITYWALLET = 48;

  private static final int LAYOUT_FRAGMENTCALENDERDIALOG = 49;

  private static final int LAYOUT_FRAGMENTDELETE = 50;

  private static final int LAYOUT_FRAGMENTFILTERORDERS = 51;

  private static final int LAYOUT_FRAGMENTFILTERPRODUCTS = 52;

  private static final int LAYOUT_FRAGMENTFILTERSPECIAL = 53;

  private static final int LAYOUT_FRAGMENTMERCHANTHOME = 54;

  private static final int LAYOUT_FRAGMENTMERCHANTORDERS = 55;

  private static final int LAYOUT_FRAGMENTMERCHANTPROFILE = 56;

  private static final int LAYOUT_FRAGMENTRATINGDIALOG = 57;

  private static final int LAYOUT_FRAGMENTREFUSE = 58;

  private static final int LAYOUT_FRAGMENTREFUSE1 = 59;

  private static final int LAYOUT_FRAGMENTSPECIALLISTRESERVEDONE = 60;

  private static final int LAYOUT_FRAGMENTTECHNICALAPPOINTMENT = 61;

  private static final int LAYOUT_FRAGMENTTECHNICALHOME = 62;

  private static final int LAYOUT_FRAGMENTTECHNICALPROFILE = 63;

  private static final int LAYOUT_FRAGMENTTECHNICALSERVICES = 64;

  private static final int LAYOUT_FRAGMENTUSERAPPOINTMENT = 65;

  private static final int LAYOUT_FRAGMENTUSERHOME = 66;

  private static final int LAYOUT_FRAGMENTUSERORDERS = 67;

  private static final int LAYOUT_FRAGMENTUSERPROFILE = 68;

  private static final int LAYOUT_FRAGMENTWALLETCHARGE = 69;

  private static final int LAYOUT_ITEMADDRESS = 70;

  private static final int LAYOUT_ITEMAVAILABLITY = 71;

  private static final int LAYOUT_ITEMCART = 72;

  private static final int LAYOUT_ITEMCERTIFICATE = 73;

  private static final int LAYOUT_ITEMCHAT = 74;

  private static final int LAYOUT_ITEMDAY = 75;

  private static final int LAYOUT_ITEMDEP = 76;

  private static final int LAYOUT_ITEMHOMEPRODUCT = 77;

  private static final int LAYOUT_ITEMHOMEPRODUCT1 = 78;

  private static final int LAYOUT_ITEMIMAGE = 79;

  private static final int LAYOUT_ITEMIMAGES = 80;

  private static final int LAYOUT_ITEMMERCHANTORDERS = 81;

  private static final int LAYOUT_ITEMMOSTPRODUCT = 82;

  private static final int LAYOUT_ITEMNOTS = 83;

  private static final int LAYOUT_ITEMORDERS = 84;

  private static final int LAYOUT_ITEMPACKAGES = 85;

  private static final int LAYOUT_ITEMPRODUCT = 86;

  private static final int LAYOUT_ITEMPRODUCTORDER = 87;

  private static final int LAYOUT_ITEMPRODUCTRATE = 88;

  private static final int LAYOUT_ITEMRATEING = 89;

  private static final int LAYOUT_ITEMSERVICEIMAGE = 90;

  private static final int LAYOUT_ITEMSERVICES = 91;

  private static final int LAYOUT_ITEMSERVICES1 = 92;

  private static final int LAYOUT_ITEMSERVICESDETAILS = 93;

  private static final int LAYOUT_ITEMSPECIAL = 94;

  private static final int LAYOUT_ITEMSPECIAL1 = 95;

  private static final int LAYOUT_ITEMTECHNICALAPPOINTMENT = 96;

  private static final int LAYOUT_ITEMTECHNICALSERVICE = 97;

  private static final int LAYOUT_ITEMTIME = 98;

  private static final int LAYOUT_ITEMUSERAPPOINTMENT = 99;

  private static final int LAYOUT_ITEMUSERORDER = 100;

  private static final int LAYOUT_ITEMWALLET = 101;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_cart, LAYOUT_ACTIVITYCART);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_detailsordermerchant, LAYOUT_ACTIVITYDETAILSORDERMERCHANT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_detailsproducts, LAYOUT_ACTIVITYDETAILSPRODUCTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_detailsproducttechnical, LAYOUT_ACTIVITYDETAILSPRODUCTTECHNICAL);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_detailsspeciallist, LAYOUT_ACTIVITYDETAILSSPECIALLIST);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_detailsuserorder, LAYOUT_ACTIVITYDETAILSUSERORDER);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_edittrade, LAYOUT_ACTIVITYEDITTRADE);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_merchanthome, LAYOUT_ACTIVITYMERCHANTHOME);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_merchantregister, LAYOUT_ACTIVITYMERCHANTREGISTER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_mostproducts, LAYOUT_ACTIVITYMOSTPRODUCTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_myproduct, LAYOUT_ACTIVITYMYPRODUCT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_myservices, LAYOUT_ACTIVITYMYSERVICES);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_notifications, LAYOUT_ACTIVITYNOTIFICATIONS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_onboarding, LAYOUT_ACTIVITYONBOARDING);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_products, LAYOUT_ACTIVITYPRODUCTS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_profile, LAYOUT_ACTIVITYPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_rating, LAYOUT_ACTIVITYRATING);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_ratingproduct, LAYOUT_ACTIVITYRATINGPRODUCT);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.activity_wallet, LAYOUT_ACTIVITYWALLET);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.fragment_merchantprofile, LAYOUT_FRAGMENTMERCHANTPROFILE);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.fragment_userorders, LAYOUT_FRAGMENTUSERORDERS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.fragment_userprofile, LAYOUT_FRAGMENTUSERPROFILE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.fragment_walletcharge, LAYOUT_FRAGMENTWALLETCHARGE);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_cart, LAYOUT_ITEMCART);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_dep, LAYOUT_ITEMDEP);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_homeproduct, LAYOUT_ITEMHOMEPRODUCT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_homeproduct1, LAYOUT_ITEMHOMEPRODUCT1);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_image, LAYOUT_ITEMIMAGE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_images, LAYOUT_ITEMIMAGES);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_merchantorders, LAYOUT_ITEMMERCHANTORDERS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_mostproduct, LAYOUT_ITEMMOSTPRODUCT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_nots, LAYOUT_ITEMNOTS);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_product, LAYOUT_ITEMPRODUCT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_productorder, LAYOUT_ITEMPRODUCTORDER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_productrate, LAYOUT_ITEMPRODUCTRATE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_rateing, LAYOUT_ITEMRATEING);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_userorder, LAYOUT_ITEMUSERORDER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(fudex.bonyad.R.layout.item_wallet, LAYOUT_ITEMWALLET);
  }
    ...
    switch(internalId) {
      ...
      case  LAYOUT_ACTIVITYADDPRODUCT: {
        if ("layout/activity_addproduct_0".equals(tag)) {
          return new AddproductviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_addproduct is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ACTIVITYCART: {
        if ("layout/activity_cart_0".equals(tag)) {
          return new CartListviewModelBindingImpl(component, view);
        }
      ...
      case  LAYOUT_ACTIVITYDETAILSORDERMERCHANT: {
        if ("layout/activity_detailsordermerchant_0".equals(tag)) {
          return new DetailmerchantproductviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_detailsordermerchant is invalid. Received: " + tag);
      }
      case  LAYOUT_ACTIVITYDETAILSPRODUCTS: {
        if ("layout/activity_detailsproducts_0".equals(tag)) {
          return new DetailproductviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_detailsproducts is invalid. Received: " + tag);
      }
      case  LAYOUT_ACTIVITYDETAILSPRODUCTTECHNICAL: {
        if ("layout/activity_detailsproducttechnical_0".equals(tag)) {
          return new DetailproductmerchantviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_detailsproducttechnical is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ACTIVITYDETAILSUSERORDER: {
        if ("layout/activity_detailsuserorder_0".equals(tag)) {
          return new DetailorderuserviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_detailsuserorder is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ACTIVITYEDITTRADE: {
        if ("layout/activity_edittrade_0".equals(tag)) {
          return new EdittradeViewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_edittrade is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ACTIVITYMERCHANTHOME: {
        if ("layout/activity_merchanthome_0".equals(tag)) {
          return new MerchanthomeviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_merchanthome is invalid. Received: " + tag);
      }
      case  LAYOUT_ACTIVITYMERCHANTREGISTER: {
        if ("layout/activity_merchantregister_0".equals(tag)) {
          return new MerchantregisterviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_merchantregister is invalid. Received: " + tag);
      }
      case  LAYOUT_ACTIVITYMOSTPRODUCTS: {
        if ("layout/activity_mostproducts_0".equals(tag)) {
          return new MostproductlistviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_mostproducts is invalid. Received: " + tag);
      }
      case  LAYOUT_ACTIVITYMYPRODUCT: {
        if ("layout/activity_myproduct_0".equals(tag)) {
          return new MyproductlistviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_myproduct is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ACTIVITYNOTIFICATIONS: {
        if ("layout/activity_notifications_0".equals(tag)) {
          return new NotsListViewModelBindingImpl(component, view);
        }
      ...
      case  LAYOUT_ACTIVITYPRODUCTS: {
        if ("layout/activity_products_0".equals(tag)) {
          return new ProductsListviewModelBindingImpl(component, view);
        }
      ...
      case  LAYOUT_ACTIVITYRATING: {
        if ("layout/activity_rating_0".equals(tag)) {
          return new RatingsListViewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_rating is invalid. Received: " + tag);
      }
      case  LAYOUT_ACTIVITYRATINGPRODUCT: {
        if ("layout/activity_ratingproduct_0".equals(tag)) {
          return new RatingsproductsViewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for activity_ratingproduct is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ACTIVITYWALLET: {
        if ("layout/activity_wallet_0".equals(tag)) {
          return new WalletListViewModelBindingImpl(component, view);
        }
  ...
  private final ViewDataBinding internalGetViewDataBinding1(DataBindingComponent component,
      View view, int internalId, Object tag) {
    switch(internalId) {
      case  LAYOUT_FRAGMENTFILTERORDERS: {
        if ("layout/fragment_filterorders_0".equals(tag)) {
          return new FilterordersViewModelBindingImpl(component, view);
        }
      ...
      case  LAYOUT_FRAGMENTMERCHANTHOME: {
        if ("layout/fragment_merchanthome_0".equals(tag)) {
          return new MerchanthomefragmentViewModelBindingImpl(component, view);
        }
      ...
      case  LAYOUT_FRAGMENTMERCHANTPROFILE: {
        ...
        throw new IllegalArgumentException("The tag for fragment_merchantprofile is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_FRAGMENTUSERORDERS: {
        if ("layout/fragment_userorders_0".equals(tag)) {
          return new UserorderslistfragmentviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_userorders is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_FRAGMENTWALLETCHARGE: {
        if ("layout/fragment_walletcharge_0".equals(tag)) {
          return new ChargewalletviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_walletcharge is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ITEMCART: {
        if ("layout/item_cart_0".equals(tag)) {
          return new CartproductviewModelBindingImpl(component, view);
        }
      ...
      case  LAYOUT_ITEMDEP: {
        if ("layout/item_dep_0".equals(tag)) {
          return new CatogaryviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_dep is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMHOMEPRODUCT: {
        if ("layout/item_homeproduct_0".equals(tag)) {
          return new HomeproductviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_homeproduct is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMHOMEPRODUCT1: {
        if ("layout/item_homeproduct1_0".equals(tag)) {
          return new ProductsitemviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_homeproduct1 is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ITEMIMAGES: {
        if ("layout/item_images_0".equals(tag)) {
          return new ImagesmerchantviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_images is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMMERCHANTORDERS: {
        if ("layout/item_merchantorders_0".equals(tag)) {
          return new MerchantHomeorderviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_merchantorders is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMMOSTPRODUCT: {
        if ("layout/item_mostproduct_0".equals(tag)) {
          return new MostproductviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_mostproduct is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMNOTS: {
        if ("layout/item_nots_0".equals(tag)) {
          return new NotviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_nots is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ITEMPRODUCT: {
        if ("layout/item_product_0".equals(tag)) {
          return new MyproductviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_product is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMPRODUCTORDER: {
        if ("layout/item_productorder_0".equals(tag)) {
          return new ProductorderviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_productorder is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMPRODUCTRATE: {
        if ("layout/item_productrate_0".equals(tag)) {
          return new ProductrateviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_productrate is invalid. Received: " + tag);
      }
      case  LAYOUT_ITEMRATEING: {
        if ("layout/item_rateing_0".equals(tag)) {
          return new RatingViewBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_rateing is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_ITEMUSERORDER: {
        if ("layout/item_userorder_0".equals(tag)) {
          return new UserorderitemviewModelBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for item_userorder is invalid. Received: " + tag);
      }
    }
    return null;
  }
    ...
    switch(internalId) {
      case  LAYOUT_ITEMWALLET: {
        if ("layout/item_wallet_0".equals(tag)) {
          return new TransactionsviewModelBindingImpl(component, view);
        }
  ...
  private static class InnerLayoutIdLookup {
    static final HashMap<String, Integer> sKeys = new HashMap<String, Integer>(101);
    ...
    static {
      ...
      sKeys.put("layout/activity_cart_0", fudex.bonyad.R.layout.activity_cart);
      ...
      sKeys.put("layout/activity_detailsordermerchant_0", fudex.bonyad.R.layout.activity_detailsordermerchant);
      sKeys.put("layout/activity_detailsproducts_0", fudex.bonyad.R.layout.activity_detailsproducts);
      sKeys.put("layout/activity_detailsproducttechnical_0", fudex.bonyad.R.layout.activity_detailsproducttechnical);
      sKeys.put("layout/activity_detailsspeciallist_0", fudex.bonyad.R.layout.activity_detailsspeciallist);
      sKeys.put("layout/activity_detailsuserorder_0", fudex.bonyad.R.layout.activity_detailsuserorder);
      ...
      sKeys.put("layout/activity_edittrade_0", fudex.bonyad.R.layout.activity_edittrade);
      ...
      sKeys.put("layout/activity_merchanthome_0", fudex.bonyad.R.layout.activity_merchanthome);
      sKeys.put("layout/activity_merchantregister_0", fudex.bonyad.R.layout.activity_merchantregister);
      sKeys.put("layout/activity_mostproducts_0", fudex.bonyad.R.layout.activity_mostproducts);
      sKeys.put("layout/activity_myproduct_0", fudex.bonyad.R.layout.activity_myproduct);
      sKeys.put("layout/activity_myservices_0", fudex.bonyad.R.layout.activity_myservices);
      sKeys.put("layout/activity_notifications_0", fudex.bonyad.R.layout.activity_notifications);
      sKeys.put("layout/activity_onboarding_0", fudex.bonyad.R.layout.activity_onboarding);
      sKeys.put("layout/activity_products_0", fudex.bonyad.R.layout.activity_products);
      sKeys.put("layout/activity_profile_0", fudex.bonyad.R.layout.activity_profile);
      sKeys.put("layout/activity_rating_0", fudex.bonyad.R.layout.activity_rating);
      sKeys.put("layout/activity_ratingproduct_0", fudex.bonyad.R.layout.activity_ratingproduct);
      ...
      sKeys.put("layout/activity_wallet_0", fudex.bonyad.R.layout.activity_wallet);
      ...
      sKeys.put("layout/fragment_merchantprofile_0", fudex.bonyad.R.layout.fragment_merchantprofile);
      ...
      sKeys.put("layout/fragment_userorders_0", fudex.bonyad.R.layout.fragment_userorders);
      sKeys.put("layout/fragment_userprofile_0", fudex.bonyad.R.layout.fragment_userprofile);
      sKeys.put("layout/fragment_walletcharge_0", fudex.bonyad.R.layout.fragment_walletcharge);
      ...
      sKeys.put("layout/item_cart_0", fudex.bonyad.R.layout.item_cart);
      ...
      sKeys.put("layout/item_dep_0", fudex.bonyad.R.layout.item_dep);
      sKeys.put("layout/item_homeproduct_0", fudex.bonyad.R.layout.item_homeproduct);
      sKeys.put("layout/item_homeproduct1_0", fudex.bonyad.R.layout.item_homeproduct1);
      sKeys.put("layout/item_image_0", fudex.bonyad.R.layout.item_image);
      sKeys.put("layout/item_images_0", fudex.bonyad.R.layout.item_images);
      sKeys.put("layout/item_merchantorders_0", fudex.bonyad.R.layout.item_merchantorders);
      sKeys.put("layout/item_mostproduct_0", fudex.bonyad.R.layout.item_mostproduct);
      sKeys.put("layout/item_nots_0", fudex.bonyad.R.layout.item_nots);
      ...
      sKeys.put("layout/item_product_0", fudex.bonyad.R.layout.item_product);
      sKeys.put("layout/item_productorder_0", fudex.bonyad.R.layout.item_productorder);
      sKeys.put("layout/item_productrate_0", fudex.bonyad.R.layout.item_productrate);
      sKeys.put("layout/item_rateing_0", fudex.bonyad.R.layout.item_rateing);
      ...
      sKeys.put("layout/item_userorder_0", fudex.bonyad.R.layout.item_userorder);
      sKeys.put("layout/item_wallet_0", fudex.bonyad.R.layout.item_wallet);
    }
  }
}
