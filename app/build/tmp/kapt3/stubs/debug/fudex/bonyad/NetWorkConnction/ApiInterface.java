...
public abstract interface ApiInterface {
    ...
    @retrofit2.http.POST(value = "visa-details")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Model.ProfileModel> editvisa(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    fudex.bonyad.Data.Visadata data);
    ...
    @retrofit2.http.POST(value = "reviews/bulk")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Helper.ErrorResponse> rateproducts(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    fudex.bonyad.Data.Makeratingdata data);
    ...
    @retrofit2.http.POST(value = "wallet/charge")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Model.SubsribeModel> chargewallet(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    fudex.bonyad.Data.Chargestatus data);
    
    @retrofit2.http.POST(value = "wallet/withdraw")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Helper.ErrorResponse> withdrawewallet(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    fudex.bonyad.Data.Chargestatus data);
    
    @retrofit2.http.GET(value = "wallet/transactions")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Model.TransactionsModel> gettransactions(@retrofit2.http.Query(value = "page")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer page, @retrofit2.http.Query(value = "paginate")
    @org.jetbrains.annotations.Nullable()
    java.lang.Integer paginate);
