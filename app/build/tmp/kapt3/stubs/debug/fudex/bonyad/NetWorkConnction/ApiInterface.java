...
public abstract interface ApiInterface {
    ...
    @org.jetbrains.annotations.NotNull()
    okhttp3.RequestBody experience_years, @retrofit2.http.Part(value = "zone_id")
    @org.jetbrains.annotations.NotNull()
    okhttp3.RequestBody zone_id, @retrofit2.http.Part(value = "password")
    @org.jetbrains.annotations.NotNull()
    ...
    @retrofit2.http.GET(value = "technician/reservations/{technicalId}")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Model.AppointmentdetailsModel> gettechnicalappointmentdetails(@retrofit2.http.Path(value = "technicalId")
    int technicalId);
    
    @retrofit2.http.POST(value = "technician/reservations/{technicalId}/refuse")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Helper.ErrorResponse> refusetechnicalappointment(@retrofit2.http.Path(value = "technicalId")
    int technicalId, @retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    fudex.bonyad.Data.Userdata data);
    
    @retrofit2.http.POST(value = "technician/reservations/{technicalId}/accept")
    @org.jetbrains.annotations.Nullable()
    public abstract retrofit2.Call<fudex.bonyad.Helper.ErrorResponse> accepttechnicalappointment(@retrofit2.http.Path(value = "technicalId")
    int technicalId);
