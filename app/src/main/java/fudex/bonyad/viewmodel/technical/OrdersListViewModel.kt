...
import fudex.bonyad.ui.Adapter.technical.Ordersadapter
...
class OrdersListViewModel(var catogaryFragment: TechnicalappointmentFragment) : BaseObservable() {
    var isloading: ObservableBoolean = ObservableBoolean(false)
    var status  = ObservableField<Int>(1)
    var orderList: ArrayList<OrdersDatum> = ArrayList()
    var context: TechnicalappointmentFragment = TechnicalappointmentFragment()
    ...
    fun getorders() {
        ...
        val call: Call<OrdersModel?>? = apiService.gettechnicalmyreservation(statuses,page,10)
