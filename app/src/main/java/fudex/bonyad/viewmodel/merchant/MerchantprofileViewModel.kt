...
class MerchantprofileViewModel(var catogaryFragment: MerchantprofileFragment) : BaseObservable() {
    var isloading: ObservableBoolean = ObservableBoolean(false)
    var context: MerchantprofileFragment = MerchantprofileFragment()
    ...
    fun store(){
        var intent: Intent = Intent(activity, EdittradeActivity::class.java)
        activity.startActivity(intent)
    }
    fun logout(){
