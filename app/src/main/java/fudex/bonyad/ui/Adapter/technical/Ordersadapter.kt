...
import fudex.bonyad.databinding.TechnicalorderviewModelBinding
...
class Ordersadapter : RecyclerView.Adapter<Ordersadapter.MyViewHolder>() {
    ...
    internal lateinit var movieItem: TechnicalorderviewModelBinding
    ...
    inner class MyViewHolder(designsBinding: TechnicalorderviewModelBinding) : RecyclerView.ViewHolder(designsBinding.getRoot()) {


        internal var designsBinding: TechnicalorderviewModelBinding
            internal set
        ...
        fun bind(design: OrderViewModel) {
         ...
         fun getDesignsBinding(): TechnicalorderviewModelBinding {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        movieItem = DataBindingUtil.inflate(LayoutInflater.from(parent.context),
                R.layout.item_technicalappointment, parent, false)
