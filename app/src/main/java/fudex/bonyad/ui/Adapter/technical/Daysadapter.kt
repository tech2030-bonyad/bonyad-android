...
import fudex.bonyad.databinding.DayviewModelBinding
import fudex.bonyad.viewmodel.technical.DayViewModel
...
class Daysadapter : RecyclerView.Adapter<Daysadapter.MyViewHolder>() {
    ...
    private var horizontalList: List<DistanceModel> = ArrayList<DistanceModel>()
    internal lateinit var movieItem: DayviewModelBinding

    fun setdata(movies: List<DistanceModel>, context: Activity) {
    ...
    inner class MyViewHolder(designsBinding: DayviewModelBinding) : RecyclerView.ViewHolder(designsBinding.getRoot()) {


        internal var designsBinding: DayviewModelBinding
            internal set
        ...
        fun bind(design: DayViewModel) {
            designsBinding.model = design
            designsBinding.executePendingBindings()
        }

         fun getDesignsBinding(): DayviewModelBinding {
